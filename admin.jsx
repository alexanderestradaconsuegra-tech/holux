...
function SettingsView({ state, onRestaurantNameChange }) {
  ...
  const [delivery, setDelivery] = useState({ enabled: false, fee: "", min_order: "", zones: "", eta_minutes: "" });
